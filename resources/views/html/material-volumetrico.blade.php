...
<div class="container">
	...
	<div id="portfolio-wrapper">
		...
		<div class="four columns portfolio-item clothing others">
 		...
 		<!-- Portfolio Item -->
		<div class="four columns portfolio-item accessories clothing technology">
			<figure>
				<div class="portfolio-holder">
					<a href="single-project.html">
 		...
 		<!-- Portfolio Item -->
		<div class="four columns portfolio-item clothing accessories">
			<figure>
				<div class="portfolio-holder">
					<a href="single-project.html">
 		...
 		<!-- Portfolio Item -->
		<div class="four columns portfolio-item other food">
			<figure>
				<div class="portfolio-holder">
					<a href="single-project.html">
 		...
 		<!-- Portfolio Item -->
		<div class="four columns portfolio-item food other accessories">
			<figure>
				<div class="portfolio-holder">
					<a href="single-project.html">
		...
		<div class="four columns portfolio-item accessories clothing technology">
 		...
 		<!-- Portfolio Item -->
		<div class="four columns portfolio-item technology ">
			<figure>
				<div class="portfolio-holder">
					<a href="single-project.html">
 		...
 		<!-- Portfolio Item -->
		<div class="four columns portfolio-item technology other">
			<figure>
				<div class="portfolio-holder">
					<a href="single-project.html">
 		...
 		<!-- Portfolio Item -->
		<div class="four columns portfolio-item other">
			<figure>
				<div class="portfolio-holder">
					<a href="single-project.html">
 		...
 		<!-- Portfolio Item -->
		<div class="four columns portfolio-item other technology">
			<figure>
				<div class="portfolio-holder">
					<a href="single-project.html">
 		...
 		<!-- Portfolio Item -->
		<div class="four columns portfolio-item other accessories">
			<figure>
				<div class="portfolio-holder">
					<a href="single-project.html">
 		...
 		<!-- Portfolio Item -->
		<div class="four columns portfolio-item technology accessories clothing">
			<figure>
				<div class="portfolio-holder">
					<a href="single-project.html">
